...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugLinkedParams Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugLinkedParams Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugLinkedParams Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugLinkedParams installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugLinkedParams Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugLinkedParams installer\n"
